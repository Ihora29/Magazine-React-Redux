...
function CardCarousel() {
    ...
    return (<div className={styles.saleContainer}>
        ...
        <Carousel className={styles.Carousel} swipeable={true}
            ...
            <NavLink to="roll-of-week"><img className={styles.img} src="https://monosushi.com.ua/wp-content/uploads/2022/12/rol-tyzhnya.jpg" alt="" /></NavLink>
            ...
            <NavLink to="happy-birthday"> <img className={styles.img} src="https://monosushi.com.ua/wp-content/uploads/2022/12/den-narodzhennya-.jpg" alt="" /></NavLink>

            <NavLink to="moti"> <img className={styles.img} src="https://monosushi.com.ua/wp-content/uploads/2024/04/852h400_2_montazhnaya-oblast-1.jpg" alt="" /></NavLink>
